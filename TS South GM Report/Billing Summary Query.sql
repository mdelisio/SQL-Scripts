select [Project1].[ProjectID] as [Project1_ProjectID],
...
from Erp.Project as Project1
    inner join
    (
        select [Project].[ProjectID] as [Project_ProjectID],
               ...
               ((case
                     when SubQuery3.Calculated_TaxTotal <> 0 then
                         SubQuery3.Calculated_Billing - SubQuery3.Calculated_TaxTotal
                     else
                         SubQuery3.Calculated_Billing
                 end
                )
               ) as [Calculated_BillingFinal],
        ...
        from Erp.Project as Project
            inner join
            (
                select [QuoteDtl].[Company] as [QuoteDtl_Company],
                ...
                on SubQuery2.QuoteDtl_Company = Project.Company
                   and SubQuery2.QuoteDtl_ProjectID = Project.ProjectID
            left outer join
            (
                select [OrderHed].[Company] as [OrderHed_Company],
                            ...
                            (
                                ...
                                from Erp.InvcDtl as InvcDtl
                                    ...
                                    (
                                        ...
                                        on SubQuery6.InvcTax_Company = InvcDtl.Company
                                ...
                                group by [InvcDtl].[Company],
                                         [InvcDtl].[InvoiceNum],
                                         [SubQuery6].[Calculated_TaxTotal]
                            ) as SubQuery5
                                on SubQuery5.InvcDtl_Company = InvcHead.Company
                                   and SubQuery5.InvcDtl_InvoiceNum = InvcHead.InvoiceNum
                        group by [InvcHead].[Company],
                                 [InvcHead].[OrderNum],
                                 [SubQuery5].[Calculated_TaxTotal]
                    ) as SubQuery4
                        on SubQuery4.InvcHead_Company = OrderHed.Company
                ...
                group by [OrderHed].[Company],
                         ...
                         [SubQuery4].[Calculated_TaxTotal]
            ) as SubQuery3
                on SubQuery3.OrderHed_Company = Project.Company
                   and SubQuery3.OrderHed_ProjectID_c = Project.ProjectID
            inner join Erp.Customer as Customer
                on Project.Company = Customer.Company
