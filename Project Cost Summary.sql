select 
	...
	(isnull(case when OrderSummary.OrderDtl_OpenLine = 'false' then ProjSellPrice else sum(OrderSummary.Calculated_OrdInvVal) end,0)) as [Calculated_ProjInvBilling],
	((ProjSellPrice - ProjInvBilling)) as [Calculated_UnbilledBal],
...
inner join dbo.OrderDtl as OrderDtl on 
...
where (Project.Company = 2 and Project.ProjectID = '2170022')
